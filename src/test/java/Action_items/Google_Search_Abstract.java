...
public class Google_Search_Abstract extends Abstract_Class {
    ...
    public void googleSearch() throws InterruptedException {
        ...
        for (int i = 0; i < sports.size(); i++) {
            ...
            //Making the condition to fail the program for i=3

            // entering the value inside the search box and hit submit
            Reusable_Library_Loggers.userTypeAndHitEnter(driver, "//*[@name='q+FAIL']", sports.get(i), "input and submit", logger);
            ...
            Reusable_Library_Loggers.getScreenShot(driver, logger, "Screenshot of the search result for " + sports.get(i));
